// /opt/spark-2.1.3/bin/spark-shell --packages djgarcia:NoiseFramework:1.2,djgarcia:RandomNoise:1.0,djgarcia:SmartFiltering:1.0,JMailloH:Smart_Imputation:1.0,JMailloH:kNN_IS:3.0
...
val mv_num = meanImputedData.filter(_.contains("?")).count // 0
...
val k = 3
val pathHeader = "/home/spark/datasets/susy.header"
